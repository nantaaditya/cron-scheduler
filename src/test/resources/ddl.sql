...
('2', 'SYSTEM', now(), now(), 'SYSTEM', now(), now(), 0,
 '2', 'client-job-2', 'WebClientJob', '{
  "clientRequest": "{\"id\":\"2\",\"createdBy\":\"SYSTEM\",\"createdDate\":[2023,11,21],\"createdTime\":[10,50,0,390049000],\"modifiedBy\":\"SYSTEM\",\"modifiedDate\":[2023,11,21],\"modifiedTime\":[10,50,0,390049000],\"version\":1,\"clientName\":\"client-name-2\",\"httpMethod\":\"GET\",\"baseUrl\":\"http://localhost:8000\",\"apiPath\":\"/api/no-response\",\"headers\":{\"Content-Type\":[\"application/json\"]},\"fullApiPath\":\"/\"}",
  "jobExecutorId": "2"
}', '0 0/5 0 ? * * *', false);